          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              <div class="navbar-header"><a id="toggle-btn" href="#" class="menu-btn"><i class="icon-bars"> </i></a><a href="index.php" class="navbar-brand">
                  <div class="brand-text d-none d-md-inline-block"><strong class="text-primary">Ajouter un utilisateur</strong></div></a></div>
        ...
        <div class="container-fluid">
          ...
          <div class="row">            
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <form method="POST" action="scriptBD_ajoutUser.php" class="form-validate">
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label ">Identifiant</label>
                      <div class="col-sm-7">
                        <input type="text" name="identifiant" placeholder="identifiant" required data-msg="Ce champ est requis" class="form-control">
                      </div>
                    </div>
                    <div class="line"></div>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                        <input type="password" name="mdp" placeholder="mot de passe" required data-msg="Ce champ est requis" data-rule-minlength="6" data-msg-minlength="Le mot de passe doit comprendre au moins 6 caractères."  class="form-control">
                      </div>
                    </div>
                    <div class="line"></div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="form-control" name="nom" placeholder="nom" required data-msg="Ce champ est requis">
                      </div>
                    </div>
                    <div class="line"></div>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="form-control" name="prenom" placeholder="prénom" required  data-msg="Ce champ est requis">
                      </div>
                    </div>
                    <div class="line"></div>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                        <input type="email" name="email" required data-msg="Veuillez entrer une adresse e-mail valide" placeholder="email" class="form-control">
                      </div>
                    </div>
                    <div class="line"></div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                        <input class="form-control" type="text" name="description" placeholder="Ajouter une description">
                      </div>
                    </div>
                    <div class="line"></div>
